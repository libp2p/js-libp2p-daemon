...
var $root = $protobuf.roots["libp2p-daemon"] || ($protobuf.roots["libp2p-daemon"] = {});
...
$root.IdentifyResponse = (function() {
...
$root.ConnectRequest = (function() {
     ...
     * @instance
     */
    ConnectRequest.prototype.timeout = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
...
$root.StreamOpenRequest = (function() {
     ...
     * @instance
     */
    StreamOpenRequest.prototype.timeout = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
...
$root.StreamHandlerRequest = (function() {
...
$root.DHTRequest = (function() {
     ...
     * @instance
     */
    DHTRequest.prototype.peer = $util.newBuffer([]);
     ...
     * @instance
     */
    DHTRequest.prototype.cid = $util.newBuffer([]);
     ...
     * @instance
     */
    DHTRequest.prototype.key = $util.newBuffer([]);
     ...
     * @instance
     */
    DHTRequest.prototype.value = $util.newBuffer([]);
     ...
     * @instance
     */
    DHTRequest.prototype.timeout = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
...
$root.DHTResponse = (function() {
     ...
     * @instance
     */
    DHTResponse.prototype.value = $util.newBuffer([]);
...
$root.ConnManagerRequest = (function() {
     ...
     * @instance
     */
    ConnManagerRequest.prototype.peer = $util.newBuffer([]);
     ...
     * @instance
     */
    ConnManagerRequest.prototype.tag = "";
     ...
     * @instance
     */
    ConnManagerRequest.prototype.weight = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
...
$root.PSRequest = (function() {
     ...
     * @instance
     */
    PSRequest.prototype.data = $util.newBuffer([]);
...
$root.PSMessage = (function() {
     ...
     * @instance
     */
    PSMessage.prototype.from = $util.newBuffer([]);
     ...
     * @instance
     */
    PSMessage.prototype.data = $util.newBuffer([]);
     ...
     * @instance
     */
    PSMessage.prototype.seqno = $util.newBuffer([]);
     ...
     * @instance
     */
    PSMessage.prototype.signature = $util.newBuffer([]);
     ...
     * @instance
     */
    PSMessage.prototype.key = $util.newBuffer([]);
...
$root.PeerstoreRequest = (function() {
     ...
     * @instance
     */
    PeerstoreRequest.prototype.id = $util.newBuffer([]);
...
$root.PeerstoreResponse = (function() {
